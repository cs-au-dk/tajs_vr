...
public class StaticDeterminacyContextSensitivityStrategy extends BasicContextSensitivityStrategy {
    ...
    public Context makeFunctionEntryContext(State state, ObjectLabel function, FunctionCalls.CallInfo callInfo, Solver.SolverInterface c) {
        ...
        return Context.make(thisval, null, null, null, null, functionContext.getUnknownArg(), functionContext.getParameterNames(), functionContext.getArguments(), functionContext.getFreeVariables(), callInfo.getFreeVariablePartitioning(), function.getPropertyReadSpecialization());
    }
